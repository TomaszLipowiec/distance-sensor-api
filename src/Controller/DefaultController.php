...
class DefaultController extends AbstractController{
    ...
    public function index(EntityManagerInterface $entityManager): Response{
        ...
        $distances = $entityManager->getRepository(Distance::class)->findBy([], ['id' => 'DESC']);
    ...
    public function apiSave(EntityManagerInterface $entityManager, string $dist, string $key):  Response{

        if($key == "4a99c6e3-accc-465b-90bc-e6f3f3a892e8"){
            $distance = new Distance;

            $distance->setCm((int)$dist);
